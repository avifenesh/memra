...
#
# WP-A day 40 (OWED item 4, research/spill-a-20260919/DAY40.md design S; since day 42 design S2, DAY42.md): the span
# receipts' red arms, two boots each:
#   span-flip-landed    r2's demote's first f32 span has one landed byte flipped after its copy and before its event;
#                       the span receipt's landed digests (sealed at the hand-off, required before the publication)
#                       witness it: one typed `span landed bytes differ from their device source` refusal, nothing
