"""Finish target-20/draft-20 randomized-D development feedback."""
...
def main():
    ...
    records = [
        run_one(
            ...
            extra=(f"explore-seed={20785000 + index * 31 + 20}",),
        )
        for index, entry in enumerate(topics)
    ]
    save(args.out / "target20-draft20-randomd.json", {
        "schema": 1,
        "scope": "temperature 1.0 randomized D with target and draft top-k=20",
        "records": records,
    })
