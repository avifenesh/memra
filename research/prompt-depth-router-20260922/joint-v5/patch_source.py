"""Rebuild the exact v5 sampler-top-k and C/D research source."""
...
PYTHON = ()
DESTINATION = "research/prompt-depth-router-20260922/joint-v5"
...
def seal(source, patch, pins_path, out):
    ...
    archive = out / "runtime-source-joint-v5.tar.gz"
    members = 0
