"""Rebuild the exact corrected, confidence-observing research source."""
...
PYTHON = ("learn.py", "costs.py", "oracle.py", "run_native.py")
DESTINATION = "research/prompt-depth-router-20260922/confidence/adaptive-v3"
...
def seal(source, patch, pins_path, out):
    ...
    archive = out / "runtime-source-adaptive-v3.tar.gz"
    members = 0
