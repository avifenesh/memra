...
def main():
    ...
    if decisions == 0 or record["format"] != 8 or functional != 8 or record["loops"]:
        raise ValueError("v7 single-head sampled C engagement or code qualifier failed")
    result = {
        "schema": 1,
        "status": "single-head-learned-C-engaged",
