...
env = dict(os.environ, MEMRA_COMPAT='openai', MEMRA_ADDR='127.0.0.1:18090', MEMRA_CTX='4096', MEMRA_SERVE_SPEC='0', MEMRA_MODELS='g=/data/models/gemma4/gemma-4-12b-it-qat-q4_0.gguf')
...
with open('/root/lane/tok-server.log','w') as log:
    server = subprocess.Popen(['/root/target-tokenize/release/memra-server'], env=env, stdout=log, stderr=subprocess.STDOUT)
    try:
