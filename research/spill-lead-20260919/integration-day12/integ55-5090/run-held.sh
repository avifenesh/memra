#!/usr/bin/env bash
# integ55 (B day 35, the prefix seed booked under MEMRA_ADMIT_BY_MEMORY, on main 55679db26 at 38b35dc5e) on the
...
flock -u 9
echo "$(date -u +%FT%TZ) collector hold released; INTEG55-5090-DONE" | tee -a "$ROOT/battery.log"
