...
(spec / gemma4 / Q35 arms SKIP: model files absent on this rig) · `serve-stress-gate: ALL GREEN (c=64 …)` ·
accept-gate ran (its lines precede the hit gate) · `SPEC-ON-CACHE-HIT GATE: 2 FAILURE(S) (qwen)`:
