...
Read in full: the crate diff vs `main` `30e9c7a38` (B day 11: `kv_tier_gate/cli.rs`, `kv_tier_gate/reclaim_contract.rs`,
...
CPU battery on the integ8 tree (`integration-day11/integ8-cpu-battery/`): fmt, `cargo test -p memra-tier -p memra-kv`,
