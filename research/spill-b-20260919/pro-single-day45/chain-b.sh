...
# mirrored to pro-single-day45/box-b/. Addendum B: the memory door on both arms, a second wave.
set -uo pipefail
R=/root/spill-receipts/b-day45b; mkdir -p "$R/bins" "$R/boots"
WT=/root/wt-b
...
S45=${S45:-09badfe575fc156d177e9fce3835da6bcde5929f}
