#!/usr/bin/env bash
# WP-B DAY42 target-card half, addendum C shape (DAY42.md 1.4 to 1.5, addenda A to C): one RTX PRO 6000 Blackwell Workstation Edition, the 27B
...
# lane did not start. Receipts under /root/spill-receipts/b-day42c.
set -uo pipefail
R=/root/spill-receipts/b-day42c; mkdir -p "$R/bins" "$R/boots"
WT=/root/wt-b
