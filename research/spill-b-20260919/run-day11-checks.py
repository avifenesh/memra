...
No GPU. Writes research/spill-b-20260919/day11-checks/final/{check-NN.log,checks.json}.
"""
import hashlib
import json
import subprocess
...
CHECKS = [
    ...
    ["python3", "research/spill-b-20260919/test-day11.py"],
    ["python3", "research/spill-b-20260919/verify-day11.py", "--require-complete"],
    ["git", "diff", "--check"],
