...
checks = [
    ...
    ("frozen", ["git", "diff", "--exit-code", "020d2047", "--", "crates/memra-tier/src/contracts.rs", "crates/memra-tier/tests/contracts"]),
    ("d-seam-unchanged", ["git", "diff", "--exit-code", "020d2047", "--", "crates/memra-tier/tests/peer/fake.rs"]),
    ("runtime-unapplied", ["git", "diff", "--exit-code", "020d2047", "--", "crates/memra-server/src/worker.rs", "crates/memra-server/src/admit_memory.rs", "crates/memra-server/src/worker/host_glm.rs"]),
]
