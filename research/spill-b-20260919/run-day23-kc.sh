#!/usr/bin/env bash
# Day 23 copy of the day-22 runner for the MERGED tree (origin/main 653c997f4, #614 small_m_tier_max; the lane's prefill_rows scope removed): same cell, receipts under rtx5090-day23/.
