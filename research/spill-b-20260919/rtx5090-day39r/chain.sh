#!/usr/bin/env bash
# DAY39 local chain, rerun as a whole order under a new name after the 2026-09-26 rig reboot interrupted rtx5090-day39 (1.3, 1.4): the eight 5090 boots in the registered order on target/day39/{red,green}
