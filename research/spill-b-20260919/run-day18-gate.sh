#!/usr/bin/env bash
# Day 18 twin-gate cell driver, local RTX 5090: tools/prefix-newest-turn-fits-gate.py (V5 identity and V6
...
# build receipts in rtx5090-day18/build-<arm>/). The collector creates --out and refuses one that exists;
...
R=${R:-$WT/research/spill-b-20260919/rtx5090-day18}
