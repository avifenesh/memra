#!/usr/bin/env bash
# WP-B local 5090 queue-e (2026-09-25, queue-d plus DAY40's local half; while the card awaits its reset): waits until the card reads healthy (a numeric
...
# registered DAY38 and DAY39 halves, DAY38 addendum D, DAY39 addendum B (and the admission gate on v3), DAY40 (day 36's cell on the final booking), DAY41 (the probe,
...
# 4. DAY40 (O3, decide-by 2026-10-07): day 36's cell on the final booking.
bash "$D/rtx5090-day40/chain.sh"; log "day 40 chain rc=$?"
# 5. DAY41 (O11, decide-by 2026-10-09).
