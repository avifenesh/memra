...
# (the first sitting's chain refused on exactly that, `[Errno 17] File exists`).
# The gate source is the checked-out /root/wt-b, recorded into the cell after the collector returns.
set -uo pipefail
