#!/usr/bin/env bash
# WP-B day 32 local chain (DAY32.md 1.2, 1.3): RTX 5090, Qwen3.5-9B NVFP4 MTP, MEMRA_CTX=65536. The binary was built
# once from main d544c6b82 (build-source.txt, build-line.txt) and copied to target/day32/memra-server; its sha256 is
...
R=$WT/research/spill-b-20260919/rtx5090-day32
BIN=$WT/target/day32/memra-server   # under target/ (gitignored)
cd "$WT" || exit 1
