#!/usr/bin/env bash
# DAY42 local chain (1.4, addenda A to D): RTX 5090, the 9B at MEMRA_CTX=65536, the host tier at 8,192 MB, burst 32 at
...
BIN=$WT/target/day42/tip/memra-server HOST_MB=8192 BURST=32 WARM=16 WARM_TOKENS=4096 WARM_MAX_TOKENS=16 BURST_MAX_CTX=34816 \
