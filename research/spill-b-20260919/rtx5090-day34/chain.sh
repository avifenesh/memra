#!/usr/bin/env bash
# WP-B day 34 local chain (DAY34.md 1.2, 1.3): RTX 5090, Qwen3.5-9B NVFP4 MTP, MEMRA_CTX=65536. The binary was built
# once from the lane tip 9f335ac48 (build-source.txt, build-line.txt) and copied to target/day34/memra-server; its sha256 is
...
R=$WT/research/spill-b-20260919/rtx5090-day34
BIN=$WT/target/day34/memra-server   # under target/ (gitignored)
cd "$WT" || exit 1
