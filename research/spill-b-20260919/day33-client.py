#!/usr/bin/env python3
"""Day 33 memra#680 cell client (DAY33.md section 1): day31-client.py plus two opt-in flags, `--skip-long` (no
class iv) and `--burst 0` (no burst). With neither flag it runs the day-31 workload byte for byte.
...
ap.add_argument("--burst", type=int, default=32, help="0 skips the burst (day 33)")
ap.add_argument("--skip-long", action="store_true", help="skip class iv (day 33)")
