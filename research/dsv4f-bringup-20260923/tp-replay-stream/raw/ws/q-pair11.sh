#!/usr/bin/env bash
# q-pair11.sh (2x RTX PRO 6000 WS pod): memra #710 full-token replay on the
...
set -u
S=/root/rcpt/q-pair11.summary; R=/root/rcpt/tpstream; mkdir -p $R
...
[[ -d /root/lane/target-tps ]] || cp -a /root/lane/target-now /root/lane/target-tps
