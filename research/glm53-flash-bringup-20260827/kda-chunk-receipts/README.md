...
> **BOX A/B RAN 2026-08-29/30 — verdict: lever does not pay at 4.6-6.5k on top of L1+L2;
> recommend HOLD, flag stays DEFAULT OFF.** Table, band, argmax and hygiene receipts in
> `box-ab/BOX-AB.md`. The plan below is the pre-registration that battery executed.
