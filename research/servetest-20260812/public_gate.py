#!/usr/bin/env python3
"""Gate one model on the public endpoint and retain content-free protocol receipts."""
...
def run(args: argparse.Namespace) -> int:
    ...
    metrics_base_url = args.metrics_base_url or args.base_url
    ...
    try:
        ...
        writer.close()
        summary = {
            "schema": "memra.cx-servetest.public-gate.v2",
