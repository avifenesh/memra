...
- 2026-08-13: Staged the complete lane as a verified Git bundle into the new `/opt/dl-image/nvme/cx-gscost/memra` checkout and built source `71682fdbdf4a3616b3ab1794bf4b75607d35dcfd` fresh with CUDA 13.2 / auto-detected sm_120a. `memra-server` SHA-256 is `d314dfc211918523d93e14454a56a323dfa8544c974254a0e7e236e822848846`; both arms will execute that one file. Post-build preflight again found both GPUs at 0 MiB, the shared lock free, and port 18468 clear.
