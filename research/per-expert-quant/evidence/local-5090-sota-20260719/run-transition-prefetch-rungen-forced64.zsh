...
log_path=$evidence_dir/hy3-rungen-transition-prefetch-ranked-nonhbm-clean-forced64-warm128-run1.log
...
/usr/bin/time -v env \
    ...
    BW24_CPU_EXPERT_TRANSITION_PREFETCH=1 \
    BW24_CPU_EXPERT_PREFETCH_IO_THREADS=2 \
