...
log_path=$evidence_dir/hy3-rungen-wholepack-packed-vector-clean-forced-control64-warm128-run1.log
...
/usr/bin/time -v env \
    ...
    BW24_CPU_EXPERT_LIB=/tmp/libbw24-cpu-experts-vec.so \
    BW24_CPU_EXPERT_VEC_SWIGLU=1 \
