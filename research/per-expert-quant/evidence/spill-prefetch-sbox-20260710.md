# Sbox cold spill prefetch result — 2026-07-10

This is a research-host result from the hyperscaler Sbox RTX PRO 6000 machine. It selects a setting for the
...
Sbox capability screen. Keep `random` selectable until matched steady-state decode and RTX 5090
