...
run lane-m4-mixed  "$LANE" MEMRA_LOCKSTEP_M=4 MEMRA_PROMPTS_FILE="$OUT/prompts.txt"
run lane-m4-same   "$LANE" MEMRA_LOCKSTEP_M=4 MEMRA_PROMPT="$P0"
run lane-m2-mixed  "$LANE" MEMRA_LOCKSTEP_M=2 MEMRA_PROMPTS_FILE="$OUT/prompts.txt"
run lane-m3-mixed  "$LANE" MEMRA_LOCKSTEP_M=3 MEMRA_PROMPTS_FILE="$OUT/prompts.txt"
run lane-m4-mixed-rows0 "$LANE" MEMRA_LOCKSTEP_M=4 MEMRA_PROMPTS_FILE="$OUT/prompts.txt" MEMRA_LOCKSTEP_CPU_ROWS=0
run base-m4-mixed  "$BASE" MEMRA_LOCKSTEP_M=4 MEMRA_PROMPTS_FILE="$OUT/prompts.txt"
