...
|---|---|---|---|---|---|
| Identity, default (spec) | RTX PRO 6000, 27B | `KV-HOST-SPILL IDENTITY GATE: ALL GREEN (teeth=0)` (12 ok) | same, 12 ok, D2H and H2D receipts `items=34` | `913095404` (day 25, over the lead's retire-seam settle and refused-submission fence release from integ36), `98170f182` (day 22), `9be3f7373` (day 21), `3df0cb2b3` (A day 18 x2), `1b354be59`, `70038ed01`, `30e433c4c`; red on `5ecfd262c` (day 13, fixed day 14) | `pro-single-day25/cells/identity-default-*`, `pro-single-day22/cells/identity-default-*`, `-day21/`, A `pro-single-day18/box/` |
| Identity, plain | RTX PRO 6000, 27B | `ALL GREEN (teeth=0)` (12 ok) | same, `items=32` | as above (green since day 13; `913095404` day 25 over the retire-seam settle) | `pro-single-day25/cells/identity-plain-*`, `pro-single-day22/cells/identity-plain-*` |
...
stall did not follow; the 9 ms is the allocation and the recurrent copies still on the owner stream), the arena handoff and the DFlash tail slice not built, and the promote-side
