...
# (lane/spill-c-20260919, refs/bundle/c16, Option C). No GPU cell. Niced and job-capped: another lane
# may hold the card while this builds.
set -uo pipefail
export PATH=/root/.cargo/bin:/usr/local/cuda/bin:$PATH
out=/root/spill-receipts/c-day16/build
mkdir -p "$out" /root/spill-receipts/c-day16/bins
cd /root/wt-c
...
cp target/release/memra-server /root/spill-receipts/c-day16/bins/memra-server
sha256sum /root/spill-receipts/c-day16/bins/memra-server > "$out/binary.sha256"
