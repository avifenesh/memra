#!/usr/bin/env python3
"""DAY81: a synthetic `i19` cell for the reader's mechanics dry check, from DAY77's target-card `i18` receipts, the arms
relabelled one step (`i17` as `i18`, `i18` as `i19`, `i18c` as `i19c`); the four profiled runs with their SQLite exports
from where they are kept. The reading means nothing. usage: make-synthetic.py <i18-cell-dir> <sqlite-dir> <out-cell-dir>
"""
import shutil
import sys
...
rename = {"i17": "i18", "i18": "i19", "i18c": "i19c"}
