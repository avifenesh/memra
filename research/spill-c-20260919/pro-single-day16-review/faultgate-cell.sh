#!/usr/bin/env bash
# tools/kv-host-contract-fault-gate.sh (door ON; demote faults contract-presubmit/postpublish and promote
# faults contract-promote-presubmit/postpublish, one-shot each) on the day-16 binary under the inherited
# collector lock. usage: faultgate-cell.sh <lockfd> <cache_mb>
set -uo pipefail
fd=$1; cache_mb=$2
