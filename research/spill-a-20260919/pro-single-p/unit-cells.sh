#!/usr/bin/env bash
# The design-P target-card unit cells on the tip tree (DAY51 section 1 (a); the design-V set of DAY47), under the collector's lock hold:
...
cargo test -p memra-server --lib -- hash_ hashing_ every_path_that_meets_a_hashing every_path_that_meets_a_demoting every_path_that_meets_a_promoting the_run_loop_waits_boundedly the_d2h_spans day31_ day33_ day34_ day35_ day36_ day38_ day41_ day42_ day47_ day49_ day51_ pause_ > "$R/unit/cpu-censuses.log" 2>&1
