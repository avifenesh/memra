#!/usr/bin/env bash
# The design-S2 target-card driver (DAY42 section 1): waits for the build receipt, then, in one sitting: ab-demote.sh
...
D=research/spill-a-20260919/pro-single-s2
...
cell trace-cell 3600 $D/trace.sh @COLLECTOR_LOCK_FD@
