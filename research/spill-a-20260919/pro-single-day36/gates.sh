#!/usr/bin/env bash
# WP-A day 36 target-card gate cell (DAY36 section 3: the day-34 set plus the fault gate plain, on the tip binary) (one RTX PRO 6000 Blackwell), run under the collector's
