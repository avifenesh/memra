#!/usr/bin/env bash
# WP-A day 26 target-card gate cell (the promoted-pin refusal of the restore route; the day-24 set) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
