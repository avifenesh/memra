#!/usr/bin/env bash
# Day-30 counts over a receipts root (DAY30.md sections 4 to 7 quote this output; nothing is counted by hand).
#   bash counts.sh pro-single-day30/box > pro-single-day30/box/counts.log     (run from research/spill-a-20260919)
#   bash counts.sh rtx5090-day30 > rtx5090-day30/counts.log
set -uo pipefail
R=${1:?receipts root}
