#!/usr/bin/env bash
# BOX3 day-30 driver (the D2H span half's acceptance, DAY30.md sections 2 and 2a): waits for the build receipt, then, in one sitting:
...
# under the collector (the door's GPU unit cells with the day-30 span cells, the engine's D2D and D2H span cells, and the CPU
...
D=research/spill-a-20260919/pro-single-day30
