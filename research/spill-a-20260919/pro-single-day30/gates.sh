#!/usr/bin/env bash
# WP-A day 30 target-card gate cell (the recurrent f32 planes ride the demote ticket as D2H spans; the day-29 set byte-for-byte) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
