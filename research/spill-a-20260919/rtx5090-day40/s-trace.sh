...
# each report exported to sqlite and read by day40-trace-reading.py; the reports stay local (their sha256 banked).
...
for arm in g4 s; do
    ...
    python3 research/spill-a-20260919/day40-trace-reading.py "$D/trace.sqlite" > "$D/reading.log" 2>&1
