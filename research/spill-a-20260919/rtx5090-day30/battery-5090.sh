#!/usr/bin/env bash
# WP-A day 30, the acceptance gate's "both cards" on the local RTX 5090 Laptop GPU (9B NVFP4 MTP artifact) with the
# day-30 tree's local release binary (the D2H span half): the identity gate default ON, the fault gate (ten
