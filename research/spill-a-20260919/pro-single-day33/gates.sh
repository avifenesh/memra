#!/usr/bin/env bash
# WP-A day 33 target-card gate cell (the day-32 set byte-for-byte; the promote-span-refusal cell reads its day-33 assertion) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
