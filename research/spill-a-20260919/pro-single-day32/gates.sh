#!/usr/bin/env bash
# WP-A day 32 target-card gate cell (the day-31 set byte-for-byte; the fault gate now carries the promote-span-refusal cell too) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
