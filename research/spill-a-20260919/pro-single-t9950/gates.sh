#!/usr/bin/env bash
# DAY44 section 1: design T's gate set on this 9950X-class host (DAY39 section 5's (c): the day-36 set, the fault gate with every cell, source-flip,
# copy-phase-hit on the host-side hold and day 41's three sources-* cells, on the ft binary) (one RTX PRO 6000 Blackwell), run under the collector's
