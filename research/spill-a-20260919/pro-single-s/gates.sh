#!/usr/bin/env bash
# The design-S target-card gate cell (DAY40 section 3's (b): the day-36 set, the fault gate with every cell, source-flip,
# copy-phase-hit on the host-side hold and day 41's three sources-* cells, on the S tip binary) (one RTX PRO 6000 Blackwell), run under the collector's
