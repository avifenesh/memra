#!/usr/bin/env bash
# The design-P2 target-card gate cell (DAY52 section 1 (a); the design-V set, DAY47 section 1 (b), with the pause gate: the day-36 set, the fault gate with every cell, source-flip,
# copy-phase-hit on the host-side hold and day 41's three sources-* cells, on the P2 tip binary) (one RTX PRO 6000 Blackwell), run under the collector's
