...
cd /root/wt-a || exit 1
git fetch -q origin lane/spill-a-20260919 lane/spill-a-integ69-20260926 >> "$L" 2>&1
git checkout -q -B lane-a-p2l2-tip "$1" >> "$L" 2>&1 || { echo "rc=2 (checkout tip)" >> "$R/build.log"; exit 2; }
