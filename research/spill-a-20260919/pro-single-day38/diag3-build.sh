#!/usr/bin/env bash
# DAY38 section 13e, outside any hold: the bisection arms, each the sitting's tip plus one diag3-<arm>.patch, built into
...
L=$R/diag3-build.log
for arm in x3 x4 x6 x8; do
  P=research/spill-a-20260919/pro-single-day38/diag3-$arm.patch
  mkdir -p "$R/bins/$arm"
