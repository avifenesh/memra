#!/usr/bin/env bash
# DAY38 section 13j, outside any hold: the bisection arms, each the sitting's tip plus one diag8-<arm>.patch, built into
...
L=$R/diag8-build.log
for arm in x27; do
  P=research/spill-a-20260919/pro-single-day38/diag8-$arm.patch
  mkdir -p "$R/bins/$arm"
