#!/usr/bin/env bash
# DAY38 section 13h, outside any hold: the bisection arms, each the sitting's tip plus one diag6-<arm>.patch, built into
...
L=$R/diag6-build.log
for arm in x21; do
  P=research/spill-a-20260919/pro-single-day38/diag6-$arm.patch
  mkdir -p "$R/bins/$arm"
