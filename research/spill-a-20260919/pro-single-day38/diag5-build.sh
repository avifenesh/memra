#!/usr/bin/env bash
# DAY38 section 13g, outside any hold: the bisection arms, each the sitting's tip plus one diag5-<arm>.patch, built into
...
L=$R/diag5-build.log
for arm in x17; do
  P=research/spill-a-20260919/pro-single-day38/diag5-$arm.patch
  mkdir -p "$R/bins/$arm"
