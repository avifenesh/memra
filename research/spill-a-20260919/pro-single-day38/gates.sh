#!/usr/bin/env bash
# WP-A day 38 target-card gate cell (DAY38 section 4: the day-36 set, the fault gate with its source-flip and copy-phase-hit cells, on the tip binary) (one RTX PRO 6000 Blackwell), run under the collector's
