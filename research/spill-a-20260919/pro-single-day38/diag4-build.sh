#!/usr/bin/env bash
# DAY38 section 13f, outside any hold: the bisection arms, each the sitting's tip plus one diag4-<arm>.patch, built into
...
L=$R/diag4-build.log
for arm in x11; do
  P=research/spill-a-20260919/pro-single-day38/diag4-$arm.patch
  mkdir -p "$R/bins/$arm"
