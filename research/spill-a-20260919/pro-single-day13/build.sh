#!/usr/bin/env bash
# Day 13 native build receipt: tier-transfer-gate release and the memra-engine release lib test
# binary at the lane tip (refs/bundle/a13, branch lane-a-day13). No GPU cell.
set -uo pipefail
