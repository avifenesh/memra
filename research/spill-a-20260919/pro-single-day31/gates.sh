#!/usr/bin/env bash
# WP-A day 31 target-card gate cell (the day-30 set byte-for-byte; the fault gate now carries the span-refusal cell) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
