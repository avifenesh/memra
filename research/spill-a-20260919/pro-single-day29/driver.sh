#!/usr/bin/env bash
# BOX3 day-29 driver (option 2a's acceptance gate, ruling 40; DAY29.md section 1.5): waits for the build receipt, then, in one sitting:
...
# under the collector (the door's GPU unit cells, the D2D engine cells, and the day-28 and day-29 CPU hash cells on this host).
...
D=research/spill-a-20260919/pro-single-day29
