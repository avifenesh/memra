...
# never touched) and build the release server, writing the receipt the driver waits for. usage: build.sh <sha>
set -uo pipefail
SHA=$1
...
git fetch origin lane/spill-a-20260919 > "$R/fetch.log" 2>&1
