#!/usr/bin/env bash
# WP-A day 29 target-card gate cell (option 2a: a hit on the Hashing entry parks one tick; the day-28 set byte-for-byte, the fault gate's demote cells with the day-29 wait) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
