#!/usr/bin/env bash
# WP-A day 28 target-card gate cell (option (a): the bundle hash off the tick; the day-26 set, the fault gate now ten cells) (BOX3, one RTX PRO 6000 Blackwell), run under the collector's
