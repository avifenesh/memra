#!/usr/bin/env bash
# WP-A day 33, the "both cards" half on the local RTX 5090 Laptop GPU (9B NVFP4 MTP artifact) with the
# day-33 tree's local release binary (the fill on the copy stream): the identity gate default ON, the fault gate (twelve
