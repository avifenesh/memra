#!/usr/bin/env bash
# Lane A day 15 copy of lane C's day-16 harness (research/spill-c-20260919/pro-single-day16/wc-cell.sh at the C lane tip),
# statement for statement, with three changes only: the receipts root (a-day15), the worktree (/root/wt-a)
# and the default port (18131). The door's cached-destination pair for its decide-by review (DAY15.md task 2).
