#!/usr/bin/env bash
# WP-A day 31, the "both cards" half on the local RTX 5090 Laptop GPU (9B NVFP4 MTP artifact) with the
# day-31 tree's local release binary (1a to 1d): the identity gate default ON, the fault gate (eleven
