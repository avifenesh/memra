...
### cu/kernels.cu — 71 symbols (fatbin `MEMRA_ENGINE_FATBIN`)
...
| activation family (gelu_tanh_mul, silu_mul incl. scaled/q8_1, swigluoai_mul_scaled, gelu_tanh) | gated-FFN activations | f32/q8_1 | — | MEMRA_Q8_FFN_FUSE2 (q8 fused arm) | fatbin/by-name |
...
### cu/qmatvec.cu — 251 symbols (fatbin `MEMRA_QMATVEC_FATBIN`)
