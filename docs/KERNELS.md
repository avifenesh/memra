...
| activation family (gelu_tanh_mul, gelu_erf_mul incl. scaled (spark25: exact-erf GELU on the gate, torch nn.GELU default, NOT the tanh form), silu_mul incl. scaled/q8_1, swigluoai_mul_scaled, swiglu_clamped_mul_scaled (step35, clamp AFTER silu), swiglu_preclamped_mul_scaled (glm5_next, clamp BEFORE silu, one-sided gate), gelu_tanh) | gated-FFN activations | f32/q8_1 | — | MEMRA_Q8_FFN_FUSE2 (q8 fused arm) | fatbin/by-name |
