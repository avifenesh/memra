...
| Minor release candidate | `v0.137.0` | PREPARED, NOT TAGGED. #325 preserves model-owned GLM/TP host images through demotion and promotion and reserves the complete pinned arena at startup; `MEMRA_GLM5_TP_KV_HOST` stays OFF, decide-by 2026-09-21. Host budget remains 0 and tenant share 50 by default. #377 admits validated DFlash retained-prefix restores and refuses failed carrier restoration. Inherited DSV4 #374/#376/#382 changes carry no GLM claim. #378 excluded pending orchestrator decision. Full roster, final-composition and pair gates remain mandatory; see `research/release-v0.137.0-20260909/RESULTS.md`. No published number moves. Publicity: skipped, maintenance release. |
