...
| Minor release candidate | `v0.137.0` | PREPARED, NOT TAGGED. #325 preserves model-owned GLM/TP host images through demotion and promotion and reserves the complete pinned arena at startup; `MEMRA_GLM5_TP_KV_HOST` stays OFF, decide-by 2026-09-21. Host budget remains 0 and tenant share 50 by default. #377 admits validated DFlash retained-prefix restores and refuses failed carrier restoration. Inherited #374 defaults `MEMRA_DSV4_REPLAY_CADENCE` and `MEMRA_DSV4_DENSE_EXACT_TAIL` ON within their admitted paths, with exact `0` rollback and seam review on 2026-09-22; #376/#382 profiling/gate changes carry no GLM claim. #379 adds the owned speculative-prime fairness walker, `MEMRA_PRIME_YIELD` OFF (unset/`0`), `1` enables bounded peer service; decide-by 2026-09-22. Receipts: `research/prefill-fairness-20260908/{RESULTS,COMPOSITION,CHUNKS,SEAM}.md`. GLM5 adapter qualification remains separate. #392 changes `MEMRA_DSV4_MOE_M1_SPLITK` to ON (unset = `graph`); explicit `0` restores sktail in a fresh process with fresh graphs, seam review 2026-09-22. Owner-accepted numeric drift and performance receipts: [Darklanes #520](https://github.com/avifenesh/darklanes/pull/520); actual unset/0 engagement: [Memra #392](https://github.com/avifenesh/memra/pull/392), namespace `splitk-default-on-b589df9-gate-r1`, binary `ae91d10f4404759b6bd0b0c102eaa074aec27aa5b86a8b5c0a772c96de5201ee`. This supplies no GLM performance claim. #378 excluded pending orchestrator decision. Rebased full roster PASS on `72d424979` on a non-serving B200: 95 kernel cells, 22 skips; Ornith flips=1 bad=0, Qwen flips=0 bad=0, both K=1..8 identical. Final-composition and pair gates remain mandatory; see `research/release-v0.137.0-20260909/REBASE-QUALIFICATION.md`. No published number moves. Publicity: skipped, maintenance release. GLM TP-2 gains opt-in GPU sampling (#378, merge `ff0937dd09b808cd97dde174de1b6aedff63a0b8`, `MEMRA_GLM5_TP_DEVICE_SAMPLE` default OFF, decide-by 2026-09-22). Five p32k OFF/ON pairs across two windows measured median wall throughput 81.32 -> 91.25 tok/s and server decode 11.89 -> 10.61 ms/token; 160-token greedy/top-k-one twins were byte-identical. Unset/0 with a restart restores host sampling. [Sampler receipts](../research/glm5-tp2-gpu-sampler-20260908/RESULTS.md). |
