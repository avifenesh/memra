...
Each card gives the shortest recommended path for one supported model. The generated, complete
support matrix remains [docs/MODELS.md](../MODELS.md); measurements remain
