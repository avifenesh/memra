...
<!-- EXEC-SURFACES:START -->
| operation | carried_prime | decode_eager | decode_batch | decode_graph | mtp_spec_draft | mtp_spec_verify | glm5_spec_draft | glm5_spec_verify | pipeline |
|---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| `AudioLogMel` | — | — | — | — | — | — | — | — | — |
| `AudioStridedConv` | — | — | — | — | — | — | — | — | — |
...
| `Embedding` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
...
| `RmsNorm` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| `FullAttention` | yes | yes | yes | yes | yes | yes | — | — | yes |
| `SlidingWindowAttention` | — | — | yes | — | yes | yes | — | — | yes |
...
| `GatedDeltaNet` | yes | — | yes | yes | yes | yes | — | — | — |
| `KimiDeltaNet` | — | — | — | — | — | — | yes | yes | yes |
| `FusedAttentionGate` | yes | — | yes | yes | yes | yes | — | — | — |
| `SeparateAttentionGate` | — | — | yes | — | yes | yes | — | — | yes |
| `DenseMlp` | yes | yes | yes | yes | yes | yes | — | yes | yes |
| `MoeMlp` | — | — | yes | yes | yes | yes | yes | yes | yes |
| `SoftmaxRouter` | — | — | yes | yes | yes | yes | — | — | — |
| `SigmoidRouter` | — | — | yes | yes | yes | yes | yes | yes | yes |
| `SqrtSoftplusRouter` | — | — | — | — | — | — | — | — | — |
| `TokenHashRouter` | — | — | — | — | — | — | — | — | — |
| `SharedMlp` | — | — | yes | yes | yes | yes | yes | yes | yes |
| `SiluActivation` | yes | yes | yes | yes | yes | yes | — | — | yes |
| `GeluTanhActivation` | — | — | yes | — | — | — | — | — | — |
| `SwiGluOaiActivation` | — | — | — | — | — | — | — | — | — |
| `SwiGluClampedActivation` | — | — | yes | — | yes | yes | — | — | yes |
| `SwiGluPreClampedActivation` | — | — | — | — | — | — | yes | yes | yes |
| `NamedActivation` | — | — | — | — | — | — | — | — | — |
| `SerialResidual` | yes | yes | yes | yes | yes | yes | yes | — | yes |
| `GemmaResidual` | — | — | yes | — | — | — | — | — | — |
...
| `GatedResidualMixer` | — | — | — | — | — | — | — | — | — |
| `PleNgramEmbedding` | — | — | — | — | — | — | — | — | — |
| `KvState` | yes | yes | yes | yes | yes | yes | — | — | yes |
| `SlidingKvState` | — | — | yes | — | yes | yes | — | — | yes |
| `RecurrentState` | yes | — | yes | yes | yes | yes | yes | yes | yes |
...
| `LogitsSoftcap` | — | yes | yes | — | — | — | — | — | — |
| `LogitsMask` | yes | yes | yes | yes | yes | yes | — | — | yes |
| `OutputProjection` | yes | yes | yes | yes | yes | yes | yes | yes | yes |
