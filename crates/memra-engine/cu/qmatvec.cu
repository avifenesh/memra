...
// ---- SLOT-MAJOR (v2) row layout. Per row the 16 qs bytes
...
// kernels. Since the 2026-08-29 MEMRA_NVFP4_BANK_V2 door removal (the TP v2 banks changed
// generated text in serving, research/step37-bankv2-removal-20260829) this layout is built
// ONLY for the EP2 whole-expert banks; this kernel is their host-canonical oracle reader
// (Engine::qmatvec_nvfp4_fast_v2) and the moe_tp2_repro harness's QT_NVFP4_V2 subject.
