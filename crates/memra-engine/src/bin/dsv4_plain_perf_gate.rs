...
impl Change {
    ...
    fn half2(self, tuned: bool) -> bool {
        matches!(self, Self::WoA) || (tuned && matches!(self, Self::Half2))
    }
...
fn main() {
    ...
    assert_eq!(
        args.len(),
        4,
        "usage: dsv4_plain_perf_gate <model-dir> <source.txt> gu-m1|half2|wo-a|all"
    );
