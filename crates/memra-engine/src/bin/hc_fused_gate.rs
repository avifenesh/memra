...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for &t in &[1usize, 4, 8] {
        ...
        // The two arms return the same four host planes (pre gates, post gates, comb, y); naming
        // the shape once keeps the closures readable and satisfies clippy's complexity bar.
