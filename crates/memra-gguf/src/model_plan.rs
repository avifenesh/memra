...
pub struct ModelPlan {
    ...
    pub vision: Option<VisionEncoderPlan>,
...
impl ModelPlan {
    pub fn compile(cfg: &ModelConfig) -> Result<Self, PlanCompileError> {
        ...
        let vision = cfg
            .vision
            .as_ref()
            .map(|vision| compile_vision(cfg, vision))
            .transpose()?;
        let multimodal = match (cfg.multimodal, vision.as_ref()) {
            ...
            (Some(multimodal), Some(vision)) => {
                ...
                Some(VisionTokenInjectionPlan {
                    ...
                    tokens_per_image: multimodal.vision_soft_tokens_per_image,
                })
            }
        };
...
fn compile_layer(
    ...
    Ok(LayerPlan {
        ...
        residual: residual_topology(cfg),
        state,
    })
}
